...
<body>
	...
	<div class="container" style="margin-top: 100px; margin-bottom: 100px;">
		<div class="row">
			<div class="col-md-4">
				<img src="images/icecream.png" style="width: 100%; height: 300px;" />
			</div>
			<div class="offset-md-1 col-md-7" style="position: relative;">
				...
				<hr />				
				<img src="images/icecream.png" style="width: 100px; height: 80px; border-radius: 50%; display: inline-block; position: absolute; top: 100px" />
				<div style="display: inline-block; visiblity: hidden; width: 100px; height: 80px"></div>
