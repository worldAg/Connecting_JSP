...
<body>
	<main class="form-signin w-100 m-auto">
		<form name="loginform" action="loginProcess.net" method="post">
    		...
    		<div>
    			<button type="button" class="w-30 btn btn-outline-secondary id-find" onclick="location.href='idfind.net'">
    				아이디 찾기
    			</button>
				<button type="button" class="w-30 btn btn-outline-secondary pw-find" onclick="location.href='pwfind.net'">
					비밀번호 찾기
				</button>
				<button type="button" class="btn btn-outline-success" onclick="location.href='register.net'">회원가입</button>
    		</div>
		</form>
	</main>
