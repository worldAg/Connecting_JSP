...
public class BoardDAO {
	...
	public List<BoardBean> getBoardListByCategoryOrderBy(int page, int limit, String category, String orderby) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public int getListCountBySmartSearch(String category, String loc) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		int totalListNum = 0;
		...
		if (category.equals("all") && loc.equals("all")) {
			...
			selectSQL = "SELECT COUNT(*) " +
                        "FROM BOARD " +
			            "WHERE CATEGORY = " + category + "AND LOC = " + loc;
		}	
		...
		try {
			...
			System.out.println("BoardDAO - getListCountBySmartSearch(String category, String loc) - " + e.getMessage());
			e.printStackTrace();
		} finally {
			try {
				if (rs != null) rs.close();
	...
	public List<BoardBean> getBoardListBySmartSearch(int page, int limit, String category, String loc) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		try {
			...
			System.out.println("BoardDAO - getBoardListBySmartSearch(int page, int limit, String category, String loc) - " + e.getMessage());
			e.printStackTrace();
		} finally {
			try {
				if (rs != null) rs.close();
	...
	public int getListCountBySearchBar(String keyword) {
		...
		try {
			...
			System.out.println("제목 키워드 \'" + keyword + "\'로 저장된 게시글 수: " + totalArticleNo + "개");
		} catch (Exception e) {
			System.out.println("BoardDAO - getListCountBySearchBar(String keyword) exception - " + e.getMessage());
			e.printStackTrace();
		} finally {	
			try {
				if (rs != null) rs.close();
	...
	public List<BoardBean> getBoardListBySearchBar(int page, int limit, String keyword) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		try {
			...
			System.out.println("BoardDAO - getBoardListBySearchBar(int page, int limit, String keyword) exception - " + e.getMessage());
			e.printStackTrace();
		} finally {
			try {
				if (rs != null) rs.close();
