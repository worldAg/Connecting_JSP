...
public class SendmailAction {
	...
	public void sendMail(String receiver, String content) {
		String subject = "ID/PW 찾기";
		/*
		 * JavaMail을 사용하여 이메일을 전송하기 위한 3가지 절차는 다음과 같습니다. 1. 호스트 이름, 사용자명 , 비밀번호 등과 같은
		 * 호스트의 모든 정보를 저장하는 Session 객체를 얻습니다. 2. 메시지를 구성합니다. 3. 메시지를 보냅니다.
		 */
		...
		try {
			...
			String sender = Myinfo.naverid + "@naver.com";
